...
export default function CriminalRecordScreen({ navigation }) {
  ...
  const handleSave = () => {
    ...
    Alert.alert('Guardado', 'Antecedentes Penales/Policiales guardados correctamente.');
    navigation.goBack();
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Carta de antecedentes Penales/Policiales</Text>
      </View>

      <View style={styles.inputGroup}>
        <Text style={styles.label}>Antecedentes Penales/Policiales (frente)</Text>
      ...
      <View style={styles.inputGroup}>
        <Text style={styles.label}>Antecedentes Penales/Policiales (parte trasera)</Text>
